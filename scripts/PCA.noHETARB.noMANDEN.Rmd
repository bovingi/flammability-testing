...
ggplot(PCAvalues, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'Flamm.PCA1.all.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj, rotation = 'varimax',
  ...
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'Flamm.PC.Table1.all.ignitions.html'))
```
...
ggplot(PCAvalues2, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'Traits.PCA1.all.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj2, rotation = 'varimax',
  ...
  string.pov = "Proportion of Variance",
  string.cpov = "Cumulative Proportion",
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'Traits.PC.Table1.all.ignitions.html')) 
```
...
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'PC.Regressions1.all.ignitions.png'), height = 8, width = 10)
```
...
ggplot(PCAvalues, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'FlammandTraits.PCA5.all.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj, rotation = 'varimax',
  ...
  string.pov = "Proportion of Variance",
  string.cpov = "Cumulative Proportion",
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'FlammandTraits.PC.Table.all.ignitions.html')) 
```
...
ggplot(PCAvalues, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'Flamm.PCA2.manual.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj, rotation = 'varimax',
  ...
  string.pov = "Proportion of Variance",
  string.cpov = "Cumulative Proportion",
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'Flamm.PC.Table2.manual.ignitions.html')) 
```
...
ggplot(PCAvalues2, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'Traits.PCA2.manual.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj2, rotation = 'varimax',
  ...
  string.pov = "Proportion of Variance",
  string.cpov = "Cumulative Proportion",
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'Traits.PC.Table2.manual.ignitions.html')) 
```
...
pca_df_main %>% 
  ...
  ggplot(aes(x = traits_pc_score, y = flamm_pc_score)) +
    ...
    theme(axis.title = element_text(size = 16, face = 'bold'),
          axis.text = element_text(size = 13),
          strip.text = element_text(size = 13, face = 'bold'))
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'PC.Regressions2.manual.ignitions.png'), height = 8, width = 10)
```
### -*-*-*-*-*-
...
ggplot(PCAvalues, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'Flamm.PCA3.natural.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj, rotation = 'varimax',
  ...
  string.pov = "Proportion of Variance",
  string.cpov = "Cumulative Proportion",
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'Flamm.PC.Table3.natural.ignitions.html')) 
```
...
ggplot(PCAvalues2, aes(x = PC1, y = PC2)) +
  ...
  xlab(u.axis.labs[1]) + 
   ylab(u.axis.labs[2]) +
  coord_equal()
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'Traits.PCA3.natural.ignitions.png'), height = 7, width = 9)
```
...
tab_pca(pcobj2, rotation = 'varimax',
  ...
  string.pov = "Proportion of Variance",
  string.cpov = "Cumulative Proportion",
  file = here('figures', 'PCA', 'noHETARBnoMANDEN', 'Traits.PC.Table3.natural.ignitions.html')) 
```
...
pca_df_main %>% 
  ...
  ggplot(aes(x = traits_pc_score, y = flamm_pc_score)) +
    ...
    theme(axis.title = element_text(size = 16, face = 'bold'),
          axis.text = element_text(size = 13),
          strip.text = element_text(size = 13, face = 'bold'))
ggsave(here('figures', 'PCA', 'noHETARBnoMANDEN', 'PC.Regressions3.natural.ignitions.png'), height = 7, width = 9)
```