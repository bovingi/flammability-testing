...
- Leaf area: because leaf area is included in some fashion in the calculation of LMA and due to it's oddly stroong correlation to dw_flam_sample and ww_flam_sample which we're interested in keeping in the models, it makes sense to remove
...
multicollinearity(fh_m3) # species barely VIF > 5 (removing lfm seemed to do the trick)
...
multicollinearity(fh_m8) # No multicollinearity
...
multicollinearity(fh_m10) # Species VIF barely > 5
...
multicollinearity(fh_m11) # Species VIF (even more) barely > 5
```
...
```{r, results = 'hide'}
fh_m1 <- lmer(fh ~ species + mpa + leaf_mass_ratio + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m1)

fh_m2 <- lmer(fh ~ species + mpa + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m2)

fh_m3 <- lmer(fh ~ species + mpa + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m3)

fh_m4 <- lmer(fh ~ species + mpa + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m4)

fh_m5 <- lmer(fh ~ species + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m5)

fh_m6 <- lmer(fh ~ species + mpa + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m6)

fh_m7 <- lmer(fh ~ species + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m7)

fh_m8 <- lmer(fh ~ species + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m8)

fh_m9 <- lmer(fh ~ species + leaf_mass_ratio + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m9)

fh_m10 <- lmer(fh ~ species + mpa + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m10)

fh_m11 <- lmer(fh ~ species + mpa + leaf_mass_ratio + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m11)

fh_m12 <- lmer(fh ~ species + leaf_mass_ratio + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m12)

fh_m13 <- lmer(fh ~ species + mpa + leaf_mass_ratio + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m13)

fh_m14 <- lmer(fh ~ species + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m14)

fh_m15 <- lmer(fh ~ species + leaf_mass_ratio + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m15)

fh_m16 <- lmer(fh ~ species + lfm + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m16) # breaks multicollinearity assumption

fh_m17 <- lmer(fh ~ species + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m17)

fh_m18 <- lmer(fh ~ species + dw_flam_sample + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m18)

fh_m19 <- lmer(fh ~ species + ww_flam_sample + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m19)

fh_m20 <- lmer(fh ~ species + sample_wt + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m20)
```

```{r}
tab_model(fh_m1, fh_m2, fh_m3, fh_m4, fh_m5, fh_m6, fh_m7, fh_m8, fh_m9, fh_m10,
          fh_m11, fh_m12, fh_m13, fh_m14, fh_m15, fh_m17, fh_m18, fh_m19, fh_m20,
          show.reflvl = TRUE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
From the above model selection, dw_flam_sample and ww_flam_sample emerged as key predictors when paired w/ species. 
...
```{r, results = 'hide'}
fh_m21 <- lmer(fh ~ lfm + mpa + dw_flam_sample + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m21)

fh_m22 <- lmer(fh ~ lfm + mpa + sample_wt + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m22)

fh_m23 <- lmer(fh ~ lfm + mpa + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m23)

# Removing LFM
fh_m24 <- lmer(fh ~ mpa + dw_flam_sample + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m24)

fh_m25 <- lmer(fh ~ mpa + sample_wt + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m25)

fh_m26 <- lmer(fh ~ mpa + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m26)

# Removing MPa
fh_m27 <- lmer(fh ~ lfm + dw_flam_sample + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m27)

fh_m28 <- lmer(fh ~ lfm + sample_wt + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m28)

fh_m29 <- lmer(fh ~ lfm + LMA + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m29)

# Removing LMA
fh_m30 <- lmer(fh ~ lfm + mpa + dw_flam_sample + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m30)

fh_m31 <- lmer(fh ~ lfm + mpa + sample_wt + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m31)

fh_m32 <- lmer(fh ~ lfm + mpa + branching + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m32)

# Removing branching
fh_m33 <- lmer(fh ~ lfm + mpa + dw_flam_sample + LMA + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m33)

fh_m34 <- lmer(fh ~ lfm + mpa + sample_wt + LMA + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m34)

fh_m35 <- lmer(fh ~ lfm + mpa + LMA + leaf_mass_ratio + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m35)

# Removing leaf mass ratio
fh_m36 <- lmer(fh ~ lfm + mpa + dw_flam_sample + LMA + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m36)

fh_m37 <- lmer(fh ~ lfm + mpa + sample_wt + LMA + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m37)

fh_m38 <- lmer(fh ~ lfm + mpa + LMA + branching + branch_volume + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m38)

# Removing volume
fh_m39 <- lmer(fh ~ lfm + mpa + dw_flam_sample + LMA + branching + leaf_mass_ratio + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m39)

fh_m40 <- lmer(fh ~ lfm + mpa + sample_wt + LMA + branching + leaf_mass_ratio + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m40)

fh_m41 <- lmer(fh ~ lfm + mpa + LMA + branching + leaf_mass_ratio + (1|plant_id), data = scaled.flamm.df)
...
```{r, results = 'hide'}
# 1.
fh_m42 <- lmer(fh ~ lfm + dw_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m42)

fh_m43 <- lmer(fh ~ lfm + sample_wt + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m43)

fh_m44 <- lmer(fh ~ lfm + branch_volume + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m44)

fh_m45 <- lmer(fh ~ mpa + dw_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m45)

fh_m46 <- lmer(fh ~ mpa + sample_wt + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m46)

fh_m47 <- lmer(fh ~ mpa + branch_volume + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m47)

# 2. 
fh_m48 <- lmer(fh ~ lfm + dw_flam_sample + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m48)

fh_m49 <- lmer(fh ~ lfm + sample_wt + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m49)

fh_m50 <- lmer(fh ~ lfm + branch_volume + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m50)

fh_m51 <- lmer(fh ~ mpa + dw_flam_sample + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m51)

fh_m52 <- lmer(fh ~ mpa + sample_wt + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m52)

fh_m53 <- lmer(fh ~ mpa + branch_volume + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m53)

# 3. 
fh_m54 <- lmer(fh ~ dw_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m54)

fh_m55 <- lmer(fh ~ sample_wt + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m55)

fh_m56 <- lmer(fh ~ branch_volume + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m56)

fh_m57 <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m57)

# 4. 
fh_m58 <- lmer(fh ~ dw_flam_sample + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m58)

fh_m59 <- lmer(fh ~ sample_wt + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m59)

fh_m60 <- lmer(fh ~ branch_volume + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m60)

fh_m61 <- lmer(fh ~ ww_flam_sample + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m61)

# 5. 
fh_m62 <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m62) # note: whoops, same as fh_m57

fh_m63 <- lmer(fh ~ mpa + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m63)

fh_m64 <- lmer(fh ~ lfm + LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m64)

# 6.
fh_m65 <- lmer(fh ~ ww_flam_sample + LMA + (1|plant_id), data = scaled.flamm.df) # note: whoops, same as fh_m61
multicollinearity(fh_m65) 

fh_m66 <- lmer(fh ~ mpa + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m66)

fh_m67 <- lmer(fh ~ lfm + LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m67)

# 7.
fh_m68 <- lmer(fh ~ LMA + branching + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m68)

# 8. 
fh_m69 <- lmer(fh ~ LMA + (1|plant_id), data = scaled.flamm.df)
multicollinearity(fh_m69)

# Adding interaction terms to random effect for top 2 models
fh_int1 <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id:species), data = scaled.flamm.df)

fh_int2 <- lmer(fh ~ ww_flam_sample + LMA + (1|plant_id:species), data = scaled.flamm.df)
```
...
- ww_flam_sample is the 'best' sample size predictor, followed up by dw_flam_sample, and distantly followed by sample_wt and branch_volume
- LFM and MPa are not significantly different in how they affect the AIC score
- The effect of including branching in the model varies
- The 'best' models are ww_flam_sample + LMA + branching and ww_flam_sample + LMA
...
```{r}
fh_top1 <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df)
summary(fh_top1, ddf = 'Kenward-Roger')

fh_top2 <- lmer(fh ~ ww_flam_sample + LMA + (1|plant_id), data = scaled.flamm.df)
summary(fh_top2, ddf = 'Kenward-Roger')
```

All of the included fixed effects are significant!
...
scaled.flamm.df.noNAs <- scaled.flamm.df %>% 
  select(fh, species, lfm, mpa, ww_flam_sample, dw_flam_sample, sample_wt, branch_volume, LMA, branching, plant_id) %>% 
  na.omit() # this removed 43 samples

# Model
fh_top1 <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df.noNAs)
...
fh_top1.0 <- lmer(fh ~ (1|plant_id), data = scaled.flamm.df.noNAs)
anova(fh_top1, fh_top1.0) #P-value shows that fixed effect has significant effect on the y

#Test effects of random effect with parametric bootstrap method
nBoot=1000
lrStat=rep(NA,nBoot)
fh_null <- lm(fh ~ ww_flam_sample + LMA + branching, data = scaled.flamm.df.noNAs) # null model
fh_alt <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df.noNAs, REML = F) # alternate model
...
# For the second example, let's throw the identified 'best' predictors and species and see what it says
fh_step2 <- lmer(fh ~ species + ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df.noNAs)
# Stepwise model selection
...
fh_step_selected <- lmer(fh ~ species + ww_flam_sample + branching + (1|plant_id), data = scaled.flamm.df) 
# Using full dataset now
AIC(fh_step_selected)
AIC(fh_top1)
# The step-selected is significantly worse; now, maybe this is because of the NAs reintroduced into the data, so this may not be a totally fair comparison.
```

## Visualization via REMEF
```{r}
fh_top1 <- lmer(fh ~ ww_flam_sample + LMA + branching + (1|plant_id), data = scaled.flamm.df.noNAs) # remef is also sensitive to NAs

scaled.flamm.df.noNAs$r_fh <- remef(fh_top1, fix = c('LMA', 'branching'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the fixed effects of LMA and branching and removing the random effects

# With REMEF
ggplot(scaled.flamm.df.noNAs, aes(x = ww_flam_sample, y = r_fh))  +
  geom_point(alpha = 0.8, color = 'gray20') +
  geom_smooth(method = 'lm', color = 'gray40') +
  labs(x = 'Wet Weight (scaled)', y = 'Flame Height (effects removed, scaled)') +
  theme_bw() +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))

# Without REMEF
ggplot(scaled.flamm.df.noNAs, aes(x = ww_flam_sample, y = fh))  +
  geom_point(alpha = 0.8, color = 'gray20') +
  geom_smooth(method = 'lm', color = 'gray40') +
  labs(x = 'Wet Weight (scaled)', y = 'Flame Height (scaled)') +
  theme_bw() +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))
```
