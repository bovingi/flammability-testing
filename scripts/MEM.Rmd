...
flam_metrics <- c(rep('fh', ncol(mem.predictors.df)), rep('fd', ncol(mem.predictors.df)),
                  rep('temp_change', ncol(mem.predictors.df)),
                  rep('heat_flux_change', ncol(mem.predictors.df)))
coef <- c(NA, NA, 0.51, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
          NA, NA, 0.8, NA, NA, NA, -1.1, NA, NA, NA, NA, NA, NA, NA,
          -0.8, NA, 0.12, NA, NA, NA, NA, 1.2, NA, NA, NA, NA, NA, NA,
          NA, NA, 0.3, NA, NA, 0.2, NA, NA, 1.3, NA, NA, NA, NA, NA)
woo <- data.frame(predictors, flam_metrics, coef)
...
woo %>% 
ggplot(aes(y = predictors, x = flam_metrics, fill = coef)) +
  geom_tile() +
  labs(y = 'Predictors', x = 'Flam. Metrics', fill = 'Coefficient') +
