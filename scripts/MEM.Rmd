...
- fh_m46: MPa + sample_wt + LMA + branching, AIC = 367.6
- fh_m57: ww_flam_sample + LMA + branching, AIC = 367.6
- fh_m55: sample_wt + LMA + branching, AIC = 368.3
- fh_m52: MPa + sample_wt + LMA, AIC = 369.4
- fh_m43: LFM + sample_wt + LMA + branching, AIC = 370.5
...
fh_m57_noLMA <- lmer(fh ~ ww_flam_sample + branching + (1|plant_id), data = scaled.flamm.df, REML = F)
...
tab_model(fh_m46, fh_m46_noLMA, fh_m57, fh_m57_noLMA, fh_m55, fh_m55_noLMA, 
...
fh_step2 <- lmer(fh ~ species + mpa + sample_wt + LMA + branching + (1|plant_id), data = scaled.flamm.df.noNAs)
# Stepwise model selection
...
fh_step_selected <- lmer(fh ~ species + sample_wt + branching + (1|plant_id), data = scaled.flamm.df) 
