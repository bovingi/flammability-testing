...
# Loess regressions
  loess.mod.CH7 <- loess(CH7 ~ time, data = df, span = 0.07534884)
  df$loess.CH7 <- predict(loess.mod.CH7)
  loess.mod.CH8 <- loess(CH8 ~ time, data = df, span = 0.03744186)
