...
### Stand-alone
```{r}
pc_labels <- c('PC1 (Heat Flux)', 'PC2 (-FD)', 'PC3 (Temp. Change)', 'PC4 (FH)', 'PC1 (Sample Size)', 'PC2 (-Branching, -MPa, LMA)', 'PC3 (-LFM, Thickness)', 'PC4 (-Density, -Leaf Ratio)')
...
```{r}
pc_labels <- c('PC1 (Heat Flux)', 'PC2 (-FD)', 'PC3 (Temp. Change)', 'PC1 (Sample Size)', 'PC2 (-Branching, -MPa, LMA)', 'PC3 (-LFM, Thickness)')
