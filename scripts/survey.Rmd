...
melted <- reshape::melt(es_likert_df) %>% 
  ...
  mutate(item_title = str_replace_all(item_title, "Of", "of"),
...
cultural <-  melted %>% 
  ...
  coord_flip() + 
  labs(y = "Percentage", title = "Cultural") +
...
reg <-  melted %>% 
  ...
  geom_bar(aes(x = reorder(item_title, very_high_value), y=value, fill=variable), position="stack", stat="identity")+
  coord_flip() + 
  labs(y = "Percentage", title = "Regulating") +
  scale_fill_manual(values = c("#595D7C", "#797F91", "#ADB6B2", "#C17C79", "#D24D4B")) +
  #scale_fill_brewer(palette="BrBG")+
  theme(legend.position="none", 
        axis.title.y = element_blank(),
...
prov <-  melted %>% 
  ...
  coord_flip() + 
  labs(y = "Percentage", title = "Provisioning") +
  scale_fill_manual(values = c("#595D7C", "#797F91", "#ADB6B2", "#C17C79", "#D24D4B")) +
  #scale_fill_brewer(palette="BrBG")+
  theme(legend.position="none", 
        axis.title.y = element_blank(),
