...
# Add an arrow
TernaryArrows(c(50, 50, 50), c(triangle2.df[i,2], 0.1, 0.1), length = 0.05, lwd = 3*triangle2.df[i,2], col = "black")
TernaryArrows(c(50, 50, 50), c(0.1, triangle2.df[i,9], 0.1), length = 0.05,lwd = 3*triangle2.df[i,9], col = "black")
TernaryArrows(c(50, 50, 50), c(0.1, 0.1, triangle2.df[i,3]), length = 0.05, lwd = 3*triangle2.df[i,3], col = "black")}
```
...
# Fire Triangles
Sustainability, Combustibility, Ignitability
