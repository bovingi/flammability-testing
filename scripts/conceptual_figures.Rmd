...
# color
r.flamm.index$color <- c('#00468BB2', '#ED0000B2', '#42B540B2', '#0099B4B2', '#925E9FB2', '#FDAF91B2', '#AD002AB2', '#ADB6B6B2', '#1B1919B2')
```
...
# Add an arrow
TernaryArrows(c(50, 50, 50), c(r.flamm.index$ignitability[i], 0.1, 0.1), length = 0.15*r.flamm.index$ignitability[i], lwd = 5*r.flamm.index$ignitability[i], col = "black")
TernaryArrows(c(50, 50, 50), c(0.1, r.flamm.index$combustibility[i], 0.1), length = 0.15*r.flamm.index$combustibility[i], lwd = 5*r.flamm.index$combustibility[i], col = "black")
TernaryArrows(c(50, 50, 50), c(0.1, 0.1, r.flamm.index$sustainability[i]), length = 0.15*r.flamm.index$sustainability[i], lwd = 5*r.flamm.index$sustainability[i], col = "black")
}
...
flam_EScores_subscores <- data.frame(
  Species = c('ARTCAL', 'ARCDEN', 'CEAGRI', 'ERIKAR', 'HETARB', 'IRIDOU', 'MALLAU', 'SALAPI', 'SALLEU'),
  drought =  c(4, 4, 4, 3, 4, 2, 4, 4, 4),
  edible =   c(2, 2, 2, 4, 2, 1, 2, 4, 4),
  flowers =  c(4, 2, 4, 4, 4, 4, 2, 4, 4),
  fragrant = c(1, 4, 4, 1, 2, 1, 4, 4, 4),
  wildlife = c(4, 4, 4, 2, 4, 2, 4, 4, 4)
) 
...
## Visualization
```{r}
# 'ARTCAL', 'ARCDEN', 'CEAGRI', 'ERIKAR', 'HETARB', 'IRIDOU', 'MALLAU', 'SALAPI', 'SALLEU'
...
# scaled version
flam_scores$labx <- c(0.13, -0.5, 0.3, -0.4, 0.2, -2.35, 0.07, 0.55, 0.55)
flam_scores$laby <- c(-0.39, -0.37, 0.77, -0.94, 2.05, -0.65, -0.8, -0.59, 0.43)
