...
flam_EScores_subscores <- data.frame(
  ...
  drought =  c(4, 4, 4, 3, 4, 4, 4, 4),
  edible =   c(2, 2, 2, 4, 2, 2, 4, 4),
  flowers =  c(4, 2, 4, 4, 4, 2, 4, 4),
  fragrant = c(1, 4, 4, 1, 2, 4, 4, 4),
  wildlife = c(4, 4, 4, 2, 4, 4, 4, 4)
) 
...
# scaled version
flam_scores$labx <- c(-0.35, -0.97, 0.02, -1.44, -0.23, -0.47, 1, 1.)
flam_scores$laby <- c(-0.53, -0.5, 0.6, -0.97, 1.96, -0.85, -0.49, 0.47)
