...
mem.predictors.df <- mem.df %>% 
  select(thickness, lfm, LMA, sample_wt, leaf_mass_ratio, branching, mpa, dw_flam_sample, ww_flam_sample, start_temp) # ten predictors (NOTE: SPECIES SHOULD BE INCLUDED AS A FIXED EFFECT)
```
