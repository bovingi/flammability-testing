...
ggplot(aes(x = species, y = value, color = species)) +
  geom_boxplot() +
  labs(x = "Species", y = "Trait Value") +
  facet_wrap(~trait, ncol = 4, scales = 'free_y', labeller = labeller(trait = flam_labels)) +
  theme_bw() +
  theme(legend.position = 'none',
...
ggsave(here('figures', 'flamm.metrics.vs.dw.exploratory.jpg'), height = 12, width = 20)

exploratory_scatterplot(flamm.df.long.scatter$ww_flam_sample, 'Wet Weight (g)')
ggsave(here('figures', 'flamm.metrics.vs.ww.exploratory.jpg'), height = 12, width = 20)
```
