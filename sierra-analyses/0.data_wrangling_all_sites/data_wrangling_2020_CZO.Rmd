...
```{r}
raw.data.czo <- read_csv(here("sierra-analyses", "raw-data", "flam.curves.ssCZO.all.data.new.utf8.csv")) 
raw.data.czo %>% 
...
write.csv(rwc.data, here("sierra-analyses", "processed-data", "czo_2020_flam_curve_physiological_data.csv"))
...
write.csv(x = hp.czo.all, (here('sierra-analyses', "processed-data", "czo_2020_flam_data_all.csv")))
```
