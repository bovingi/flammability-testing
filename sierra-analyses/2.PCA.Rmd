...
source(here::here("sierra-analyses", "scripts_functions", "figure_info_sierra_flammability.R")) #color and theme info is here
```
...
sierra_flamdata_pca_all <- read_csv(here('sierra-analyses', "processed-data", "sierra_flam_data_all.csv"), show_col_types = FALSE) 
...
ggsave(here('sierra-analyses',"figures", "pca.jpg"),
       height = 7, width = 9)
```
...
write_csv(mem_data, here('sierra-analyses', "processed-data", "mem_data_sierra_alldates.csv"))
```
...
ggsave(here("sierra-analyses", "figures", "PCA.spp.diff.jpg"), height = 8, width = 10) 
...
save_kable(here('sierra-analyses','figures', 'pca_table.jpeg'))
